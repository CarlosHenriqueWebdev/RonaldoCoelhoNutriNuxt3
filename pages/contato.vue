  ...
  <div class="flex flex-col gap-[100px]">
    ...
    >
      <div class="flex flex-col gap-[32px] md:grid md:grid-cols-[686fr_402fr]">
            ...
            <div class="flex flex-col gap-[16px]">
              <div class="flex flex-col gap-[8px]">
                <label for="name" class="block font-bold"
                  >Name<span class="text-[#B95757]">*</span></label
                >
                <input
                  id="name"
                  v-model="name"
              ...
              <div class="flex flex-col gap-[8px]">
                <label for="email" class="block font-bold"
                  >Email<span class="text-[#B95757]">*</span></label
                >
                <input
                  id="email"
                  v-model="email"
              ...
              <div class="flex flex-col gap-[8px]">
                <label for="message" class="block font-bold"
                  >Message<span class="text-[#B95757]">*</span></label
                >
                <textarea
                  id="message"
                  v-model="message"
        ...
        >
          <h3 class="text-[1rem] uppercase font-bold">Contact Info</h3>
          <ul class="flex flex-col gap-[24px] text-[0.875rem]">
...
useHead({
  ...
  meta: [
    ...
    {
      property: "og:image",
      content: "http://localhost:3000/assets/images/contact-image.webp",
