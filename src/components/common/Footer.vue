<template>
    <footer class="flex flex-col text-lavender-haze bg-midnight-blue mt-[100px]">
        <div :style="{ backgroundImage: `url(${`/assets/images/img6.jpg`})` }" class="py-[80px] md:py-[0px] bg-right bg-fixed border-solid border-t-[2px] border-silver-mist-25">
            ...
            <li class="flex flex-col gap-[24px]">
                ...
                <ul class="flex flex-col gap-[16px]">
                    <li v-for="contact in contactInfo" :key="contact.name" class="flex gap-[8px]">
                        <nuxt-img :src="`/assets/images/${contact.icon}`" class="w-[22px] h-[22px]" alt="Logo" />
