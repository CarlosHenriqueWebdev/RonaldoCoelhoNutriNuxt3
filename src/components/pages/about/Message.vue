<template>
  <div class="bg-midnight-blue">
    <div
      class="mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px] px-[24px] py-[80px] lg:px-[80px] flex flex-col gap-[32px] text-lavender-haze md:flex-row"
    >
      <ClientOnly>
        <nuxt-img
          v-lazy="`/assets/images/detail5.webp`"
