        ...
        >
            <div class="flex flex-col gap-[32px]">
                ...
                <div class="flex flex-col gap-[32px]">
                    ...
                    <!-- Static Section: FAQ -->
                    <div
                        class="flex flex-col gap-[32px] relative after:content-[''] after:absolute after:w-[200px] after:h-[200px] after:bg-no-repeat after:bg-contain after:right-0 after:top-[-24px] lg:after:top-[0px] lg:after:w-[350px] lg:after:h-[350px] lg:after:top-[-50px] lg:after:right-[-50px] detail8"
                    >
                        <TitleSection
            ...
            <div>
                <ul
                    class="flex flex-col gap-[24px] bg-midnight-blue p-[24px] rounded-[4px] text-lavender-haze text-[14px] md:sticky md:top-[6px]"
                >
